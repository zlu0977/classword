...
public class SimonScreenZheng extends ClickableScreen implements Runnable {
	...
	private void getButtons() {
		...
		ButtonInterface button2 = getAButton(10, 150, 50, 50, Color.blue);
		ButtonInterface button3 = getAButton(10, 150, 50, 50, Color.yellow);
		ButtonInterface button4 = getAButton(10, 150, 50, 50, Color.green);
